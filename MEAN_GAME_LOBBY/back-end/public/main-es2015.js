...
let AppComponent = class AppComponent {
    constructor(dialog, share, router) {
        this.dialog = dialog;
        this.share = share;
        this.router = router;
    ...
    login() {
        this.dialog.open(_components_login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"], { width: '500px', height: '450px' }).afterClosed().subscribe(() => {
...
let AddPlayerComponent = class AddPlayerComponent {
    constructor(data, fb, player_service, game_service, dialogRef, share) {
        this.data = data;
        this.fb = fb;
...
let AdminScreenComponent = class AdminScreenComponent {
    constructor(player_service, dialog, share) {
        this.player_service = player_service;
        this.dialog = dialog;
        this.share = share;
        this.PlayerData = [];
        ...
        this.player_service.getPlayers().subscribe(data => {
            ...
            this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_7__["MatTableDataSource"](this.PlayerData);
            setTimeout(() => {
...
AdminScreenComponent.ctorParameters = () => [
...
let EditPlayerComponent = class EditPlayerComponent {
    constructor(data, player_service, game_service, dialogRef, fb) {
        this.data = data;
        this.player_service = player_service;
        this.game_service = game_service;
        this.dialogRef = dialogRef;
...
let GameListComponent = class GameListComponent {
    constructor(dialog, game_service) {
        this.dialog = dialog;
        this.game_service = game_service;
        this.Gamedata = [];
        this.displayedColumns = [
        ...
        this.game_service.getGames().subscribe(data => {
            this.Gamedata = data;
            this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](this.Gamedata);
            setTimeout(() => {
                this.dataSource.paginator = this.paginator;
            }, 0);
        });
...
let LoginComponent = class LoginComponent {
    constructor(dialogRef, share, builder, router) {
        this.dialogRef = dialogRef;
        this.share = share;
...
let PlayerListComponent = class PlayerListComponent {
    constructor(player_service, dialog) {
        this.player_service = player_service;
        this.dialog = dialog;
        this.PlayerData = [];
        this.GamePlayed = [];
        ...
        this.player_service.getPlayers().subscribe(data => {
            this.PlayerData = data;
            this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](this.PlayerData);
            setTimeout(() => {
                this.dataSource.paginator = this.paginator;
            }, 0);
        });
...
let PlayerService = class PlayerService {
    ...
    getPlayer(id) {
        ...
        return this.http.get(API_URL, { headers: this.headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((res) => {
            return res;
        }));
    }
    // Update student
